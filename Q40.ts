...
for the number of tracks, add that value to the album’s Object. Make at least one new function call 
...
let make_album = (
  ...
  let albumOne = make_album("Hassan", "Sukoon");
  console.log(albumOne);
  let albumTwo = make_album("Atif", "Kuch is tarah");
  console.log(albumTwo);
  let albumThree = make_album("Zayn Malik", "Night Changes", 3);
