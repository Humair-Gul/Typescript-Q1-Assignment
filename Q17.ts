...
console.log("Sorry I can't invite more than two friends due to space unavailibity")
let Guest = ["Ali", "Amir", "Haider", "Hanan","Abrar","Asad","Usama"];
while (Guest.length > 2) {
    const removeGuest = Guest.pop();
    console.log(`Sorry ${removeGuest}, I can't invite you due to space unavailibility.`);
  }
